          ...
          <div class="login-form">
            ...
            <el-form :model="loginForm" :rules="loginRules" ref="loginFormRef">
              ...
              <el-form-item prop="captcha">
                <el-row>
                  <el-col :span="10">
                    <base-input v-model="loginForm.captcha" placeholder="验证码" style="max-width: 120px;"
                                @keyup.enter="handleLogin"/>
                  </el-col>
                  <el-col :offset="2" :span="6">
                    <img @click="refreshImage" :src="captchaImgUrl" alt="验证码"
              ...
              <el-form-item class="mt20">
                <base-button type="primary" size="large" class="w100" color="#4468f3" @click="handleLogin"
                             :loading="loading">
                  登 录
                </base-button>
              </el-form-item>
...
const {VITE_BASE_CAPTCHA_API} = useEnv();
...
const captchaImgUrl = ref(`${VITE_BASE_CAPTCHA_API}?rand=${Math.random()}`);
const refreshImage = () => {
  captchaImgUrl.value = `${VITE_BASE_CAPTCHA_API}?rand=${Math.random()}`;
};
